...
$Url64 = 'https://github.com/docker/scout-cli/releases/download/v1.23.0/docker-scout_1.23.0_windows_amd64.zip'
$Checksum64 = '6525e0075a8e04c8370f5020f3b599617041196c132d53b319b4ec2e854418ae'
