...
$Url64 = 'https://github.com/docker/scout-cli/releases/download/v1.23.1/docker-scout_1.23.1_windows_amd64.zip'
$Checksum64 = 'ade9f9dc9e6864c1b268149cb87e12d4683bac19b80cba0f44d4bfbf23ef9f70'
