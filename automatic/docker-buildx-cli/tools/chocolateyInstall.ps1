...
$Url64 = 'https://github.com/docker/buildx/releases/download/v0.36.1/buildx-v0.36.1.windows-amd64.exe'
$Checksum64 = 'cd7d06a00d924b5800d2654b507afe100378a4685fcec6585eeadc599a527330'
